...
STATIC_ROOT = '/home/taxin/taxinmiasin/project/main/static'
...
AJAX_LOOKUP_CHANNELS = {
    ...
    #'person'  : {'model': 'main.person', 'search_field': 'name_en'},
    # define a custom lookup channel
    'street' : ('main.lookups', 'StreetLookup'),
    #'street' : {'model': 'main.Streets', 'search_field': 'name_en'},
    #'haystreet' : ('main.lookups', 'HayStreetLookup')
}
...
POSTMARK_API_KEY = "5b7ea031-268f-4b58-b7e1-9f624be15109"
POSTMARK_API_USER = "bigelow"
POSTMARK_API_PASSWORD = "verysecure"
DEFAULT_FROM_EMAIL = 'info@taxinmiasin.com'
