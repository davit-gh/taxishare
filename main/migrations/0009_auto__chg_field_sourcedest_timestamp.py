...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceDest.timestamp'
        db.alter_column(u'main_sourcedest', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'SourceDest.timestamp'
        db.alter_column(u'main_sourcedest', 'timestamp', self.gf('django.db.models.fields.TimeField')())
