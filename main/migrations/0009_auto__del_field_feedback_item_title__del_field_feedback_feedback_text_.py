...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Feedback.item_title'
        db.delete_column(u'main_feedback', 'item_title')

        # Deleting field 'Feedback.feedback_text'
        db.delete_column(u'main_feedback', 'feedback_text')

        # Adding field 'Feedback.title'
        db.add_column(u'main_feedback', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Feedback.feedback_desc'
        db.add_column(u'main_feedback', 'feedback_desc',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Feedback.item_title'
        db.add_column(u'main_feedback', 'item_title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Feedback.feedback_text'
        db.add_column(u'main_feedback', 'feedback_text',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'Feedback.title'
        db.delete_column(u'main_feedback', 'title')

        # Deleting field 'Feedback.feedback_desc'
        db.delete_column(u'main_feedback', 'feedback_desc')
