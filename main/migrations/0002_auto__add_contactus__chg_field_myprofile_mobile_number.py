...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MyProfile.mobile_number'
        db.alter_column(u'main_myprofile', 'mobile_number', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MyProfile.mobile_number'
        db.alter_column(u'main_myprofile', 'mobile_number', self.gf('django.db.models.fields.IntegerField')())
