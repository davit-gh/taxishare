...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_sourcedest', (
            ...
            ('streets', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Streets'], blank=True)),
        ))
    ...
    models = {
        ...
        u'main.sourcedest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'streets': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Streets']", 'blank': 'True'})
        },
        u'main.streets': {
