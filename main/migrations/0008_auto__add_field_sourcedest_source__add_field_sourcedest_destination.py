...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_sourcedest', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='source_set', blank=True, to=orm['happenings.Streets']),
                      keep_default=False)

        # Adding field 'SourceDest.destination'
        db.add_column(u'main_sourcedest', 'destination',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='destination_set', blank=True, to=orm['happenings.Streets']),
                      keep_default=False)
