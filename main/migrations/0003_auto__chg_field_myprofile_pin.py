...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MyProfile.pin'
        db.alter_column(u'main_myprofile', 'pin', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'MyProfile.pin'
        db.alter_column(u'main_myprofile', 'pin', self.gf('django.db.models.fields.IntegerField')())
