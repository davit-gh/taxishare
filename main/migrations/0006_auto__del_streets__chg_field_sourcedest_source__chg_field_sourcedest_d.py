...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceDest.source'
        db.alter_column(u'main_sourcedest', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['happenings.Streets']))

        # Changing field 'SourceDest.destination'
        db.alter_column(u'main_sourcedest', 'destination_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['happenings.Streets']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SourceDest.source'
        db.alter_column(u'main_sourcedest', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Streets']))

        # Changing field 'SourceDest.destination'
        db.alter_column(u'main_sourcedest', 'destination_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Streets']))
